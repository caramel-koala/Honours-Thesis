...
\caption{Two neighbouring tessellations, $C_L$(red) and $C_R$(blue). Only centres on the convex hulls and their bisecting lines are shown. The upper and lower tangents, $t_u$ and $t_l$ are shown in black}
\label{fig:v_merge1}
\end{figure}
