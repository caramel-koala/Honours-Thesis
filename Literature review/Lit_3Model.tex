...
%--------------------------------------------------------------------------------------
\subsection{Related Work: Standard Voronoi Faceting}\label{ra:ssec:svf}
In \citep{tasse2014applying} and \citep{smirnov2015radio}, a series of simulated extragalactic points are clustered into facets using a voronoi tessellation algorithm, the seed points for these facets are determined using a K-means algorithm. Another example of this can be seen in Figure \ref{tes:fig:stelvor} where the facets are superimposed over the source image from which they are derived.
%
\begin{figure}[H]
    \centering
    %\includegraphics[scale=0.65]{Images/voronoi.jpg}
